...
uint16_t adc_converted_value[3] = {1457,1238,3000};

int8_t channel_count = 0;
int8_t Chx_count = 0;
uint8_t Rx5808_channel;
uint16_t Rx5808_RSSI_Ad_Min0 = 0;
uint16_t Rx5808_RSSI_Ad_Max0 = 4095;
uint16_t Rx5808_RSSI_Ad_Min1 = 0;
...
void RX5808_RSSI_ADC_Init()
{
    ...
    //ADC_RegularChannelConfig(ADC1, ADC_Channel_9, 3, ADC_SampleTime_480Cycles);
